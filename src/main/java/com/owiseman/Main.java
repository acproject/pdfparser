...
public class Main {
    public static void main(String[] args) {
        try {
            PDDocument document = Loader.loadPDF(new RandomAccessReadBufferedFile(Paths.get("/Users/acproject/workspace/python_projects/embedding_server/examples/2024-Aligning Large Language Models with Humans.pdf").toFile()));
            ...
            stripper.addRegion("region", new Rectangle2D.Double(101 / 2, 208 / 2, 939 / 2, (281-208)/2));
            ...
            try {
                String markdown = converter.convert("/Users/acproject/workspace/python_projects/embedding_server/examples/2024-Aligning Large Language Models with Humans.pdf", blocks);
                Files.write(Paths.get("src/main/resources/output.md"), markdown.getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            }
